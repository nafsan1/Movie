...
public class AlarmReceiver extends BroadcastReceiver {
    public static final String TYPE_ONE_TIME = "Movie Today";
    public static final String TYPE_REPEATING = "Hellooo....";
    ...
    public void onReceive(Context context, Intent intent) {
        ...
        String title = type.equals(TYPE_ONE_TIME) ? TYPE_ONE_TIME : TYPE_REPEATING;
    ...
    public void setDailyReminderAlarm(Context context, String type, String time, String message) {
        ...
        //Toast.makeText(context, "Repeat daily reminder alarm set up", Toast.LENGTH_SHORT).show();
